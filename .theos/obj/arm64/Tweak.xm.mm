...
@class BSPlatform; @class CSQuickActionsView; @class SBFloatingDockPlatterView; @class MRUNowPlayingTransportControlsView; @class _UIBatteryView; @class _UIStatusBarVisualProvider_iOS; @class NCNotificationListSectionRevealHintView; @class CSAdjunctItemView; @class SBIconProgressView; @class SBPressGestureRecognizer; @class BBServer; @class SBClickGestureRecognizer; @class MRUNowPlayingHeaderView; @class BBBulletin; @class _UIStatusBarData; @class UIWindow; @class SBIconListPageControl; @class SBHomeHardwareButtonActions; @class MTLumaDodgePillSettings; @class SBVolumeHardwareButton; @class SBDockView; @class MRUNowPlayingControlsView; @class SBIconView; @class SBLockScreenManager; @class SpringBoard; @class SBLockHardwareButtonActions; @class SBWallpaperViewController; @class SBMediaController; @class SBLockHardwareButton; @class NCNotificationShortLookView; @class MRUNowPlayingLabelView; @class SBUIController; @class _UIStatusBarVisualProvider_Split54; @class SBHDefaultIconListLayoutProvider; @class UIKeyboardImpl; @class SBFLockScreenDateView; @class CSCoverSheetViewController; @class SBHomeHardwareButton; @class NCNotificationListCell; 
...
static __attribute__((constructor)) void _logosLocalCtor_77414ea6(int __unused argc, char __unused **argv, char __unused **envp) {
