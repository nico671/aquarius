...
@class SBIconView; @class NCNotificationListCell; @class NCNotificationShortLookView; @class NCNotificationContentView; @class _UIStatusBarCellularSignalView; @class _UIBatteryView; @class MRUNowPlayingHeaderView; @class CSAdjunctItemView; @class MRUNowPlayingTransportControlsView; @class MRUNowPlayingControlsView; @class _UIStatusBar; @class _UIStatusBarWifiSignalView; @class _UIStatusBarStringView; @class SBMediaController; @class SBIconProgressView; @class SBIconListPageControl; @class _UIStatusBarSignalView; @class PLPlatterHeaderContentView; @class _UIStatusBarVisualProvider_Split54; @class MRUNowPlayingLabelView; 
...
static __attribute__((constructor)) void _logosLocalCtor_8d8bb6ac(int __unused argc, char __unused **argv, char __unused **envp) {
