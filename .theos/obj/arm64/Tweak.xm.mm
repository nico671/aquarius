...
@class PLPlatterHeaderContentView; @class _UIStatusBarVisualProvider_Split54; @class SBMediaController; @class MRUNowPlayingTransportControlsView; @class _UIStatusBarStringView; @class _UIStatusBarCellularSignalView; @class MRUNowPlayingHeaderView; @class SBIconListPageControl; @class MRUNowPlayingControlsView; @class NCNotificationContentView; @class _UIStatusBarWifiSignalView; @class NCNotificationShortLookView; @class NCNotificationListCell; @class _UIBatteryView; @class SBIconProgressView; @class SpringBoard; @class _UIStatusBar; @class _UIStatusBarSignalView; @class CSAdjunctItemView; @class SBIconView; @class MRUNowPlayingLabelView; 
...
static __attribute__((constructor)) void _logosLocalCtor_813307cf(int __unused argc, char __unused **argv, char __unused **envp) {
