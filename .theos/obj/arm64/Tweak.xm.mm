...
@class _UIStatusBarWifiSignalView; @class NCNotificationContentView; @class _UIStatusBarStringView; @class MRUNowPlayingHeaderView; @class NCNotificationListCell; @class SBMediaController; @class SBIconView; @class SpringBoard; @class GRPAppCell; @class _UIBatteryView; @class SBIconProgressView; @class SPTMobileMediaKitAudioPlaybackManager; @class CSAdjunctItemView; @class NCNotificationShortLookView; @class _UIStatusBarVisualProvider_Split54; @class _UIStatusBarCellularSignalView; @class MRUNowPlayingControlsView; @class _UIStatusBar; @class PLPlatterHeaderContentView; @class MRUNowPlayingTransportControlsView; @class MRUNowPlayingLabelView; @class _UIStatusBarSignalView; 
