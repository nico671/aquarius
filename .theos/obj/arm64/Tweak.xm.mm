...
@class SBHomeHardwareButtonActions; @class SBLockScreenManager; @class NCNotificationShortLookView; @class SBLockHardwareButtonActions; @class SBFloatingDockPlatterView; @class NCNotificationListSectionRevealHintView; @class MRUNowPlayingLabelView; @class NCNotificationListCell; @class MRUNowPlayingHeaderView; @class MRUNowPlayingControlsView; @class MRUNowPlayingTransportControlsView; @class _UIStatusBarData; @class UIWindow; @class BSPlatform; @class _UIStatusBarVisualProvider_Split54; @class SBUIController; @class _UIBatteryView; @class CSAdjunctItemView; @class SBDockView; @class SBWallpaperViewController; @class BBBulletin; @class CSCoverSheetViewController; @class SpringBoard; @class SBIconProgressView; @class SBIconListPageControl; @class SBFLockScreenDateView; @class SBIconView; @class SBVolumeHardwareButton; @class SBLockHardwareButton; @class SBHDefaultIconListLayoutProvider; @class _UIStatusBarVisualProvider_iOS; @class NCNotificationShortLookViewController; @class BBServer; @class UIKeyboardImpl; @class SBClickGestureRecognizer; @class SBPressGestureRecognizer; @class SBHomeHardwareButton; @class SBMediaController; @class MTLumaDodgePillSettings; @class CSQuickActionsView; 
...
static __attribute__((constructor)) void _logosLocalCtor_a35ce69e(int __unused argc, char __unused **argv, char __unused **envp) {
