...
@class SBIconProgressView; @class BSPlatform; @class SBHomeHardwareButtonActions; @class SBUIController; @class MRUNowPlayingControlsView; @class SBMainSwitcherViewController; @class SBFloatingDockPlatterView; @class _UIBatteryView; @class SBLockHardwareButton; @class _UIStatusBarWifiSignalView; @class NCNotificationListSectionRevealHintView; @class _UIStatusBarData; @class _UIStatusBarStringView; @class CSCoverSheetViewController; @class _UIStatusBarCellularSignalView; @class SBIconListPageControl; @class SBVolumeHardwareButton; @class SBDockView; @class SBFLockScreenDateView; @class SBLockHardwareButtonActions; @class SpringBoard; @class CSQuickActionsView; @class SBBacklightController; @class CSAdjunctItemView; @class SBHomeHardwareButton; @class SBPressGestureRecognizer; @class NCNotificationContentView; @class PLPlatterHeaderContentView; @class _UIStatusBarSignalView; @class NCNotificationListCell; @class SBFStaticWallpaperView; @class SBMediaController; @class MRUNowPlayingLabelView; @class MRUNowPlayingTransportControlsView; @class MRUNowPlayingHeaderView; @class SBHDefaultIconListLayoutProvider; @class NCNotificationShortLookView; @class SBClickGestureRecognizer; @class _UIStatusBarVisualProvider_Split54; @class MTLumaDodgePillSettings; @class SBIconView; 
