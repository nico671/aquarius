...
@class SBIconView; @class _UIStatusBarCellularSignalView; @class SBPressGestureRecognizer; @class SpringBoard; @class _UIStatusBarStringView; @class NCNotificationContentView; @class SBMainSwitcherViewController; @class _UIStatusBarVisualProvider_iOS; @class SBHomeHardwareButton; @class NCNotificationShortLookView; @class SBLockHardwareButtonActions; @class _UIBatteryView; @class _UIStatusBarVisualProvider_Split54; @class _UIStatusBarSignalView; @class SBHDefaultIconListLayoutProvider; @class CSQuickActionsView; @class NCNotificationListCell; @class CSCoverSheetViewController; @class SBFStaticWallpaperView; @class MRUNowPlayingLabelView; @class SBBacklightController; @class MTLumaDodgePillSettings; @class SBClickGestureRecognizer; @class SBIconListPageControl; @class SBFloatingDockPlatterView; @class NCNotificationListSectionRevealHintView; @class PLPlatterHeaderContentView; @class SBUIController; @class SBVolumeHardwareButton; @class SBIconProgressView; @class MRUNowPlayingTransportControlsView; @class CSAdjunctItemView; @class SBLockHardwareButton; @class SBFLockScreenDateView; @class SBHomeHardwareButtonActions; @class BSPlatform; @class SBMediaController; @class _UIStatusBarWifiSignalView; @class _UIStatusBarData; @class MRUNowPlayingHeaderView; @class MRUNowPlayingControlsView; @class SBDockView; 
