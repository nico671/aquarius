...
@class SBLockHardwareButton; @class SBIconListPageControl; @class SBPressGestureRecognizer; @class NCNotificationListSectionRevealHintView; @class SBFolderBackgroundView; @class BBBulletin; @class MRUNowPlayingLabelView; @class SBLockHardwareButtonActions; @class CSCoverSheetViewController; @class BBServer; @class SBWallpaperViewController; @class SBClickGestureRecognizer; @class SBMediaController; @class _UIStatusBarData; @class SBIconView; @class SBDockView; @class SBLockScreenManager; @class SBFLockScreenDateView; @class UIWindow; @class BSPlatform; @class CSQuickActionsView; @class MRUNowPlayingHeaderView; @class NCNotificationShortLookView; @class SBNotificationBannerDestination; @class SBFolderTitleTextField; @class SpringBoard; @class _UIBatteryView; @class SBUICallToActionLabel; @class _UIStatusBarVisualProvider_iOS; @class MRUNowPlayingTransportControlsView; @class SBHomeHardwareButtonActions; @class CSPageControl; @class UIKeyboardImpl; @class SBIconProgressView; @class SBVolumeHardwareButton; @class SBUIController; @class CSAdjunctItemView; @class MTLumaDodgePillSettings; @class SBFloatingDockPlatterView; @class SBHDefaultIconListLayoutProvider; @class MRUNowPlayingControlsView; @class SBHomeHardwareButton; @class _UIStatusBarVisualProvider_Split54; 
...
static __attribute__((constructor)) void _logosLocalCtor_494c785f(int __unused argc, char __unused **argv, char __unused **envp) {
