...
@class BSPlatform; @class SBDockView; @class SBVolumeHardwareButton; @class SBIconView; @class SBLockScreenManager; @class _UIStatusBarData; @class SpringBoard; @class MRUNowPlayingLabelView; @class MRUNowPlayingHeaderView; @class CSQuickActionsView; @class CSAdjunctItemView; @class BBBulletin; @class SBNotificationBannerDestination; @class BBServer; @class SBUICallToActionLabel; @class SBHomeHardwareButton; @class SBPressGestureRecognizer; @class SBIconProgressView; @class _UIStatusBarVisualProvider_Split54; @class SBFloatingDockPlatterView; @class CSCoverSheetViewController; @class SBLockHardwareButtonActions; @class _UIBatteryView; @class MRUNowPlayingControlsView; @class SBHDefaultIconListLayoutProvider; @class SBLockHardwareButton; @class NCNotificationShortLookView; @class SBIconListPageControl; @class UIWindow; @class MTLumaDodgePillSettings; @class _UIStatusBarVisualProvider_iOS; @class SBHomeHardwareButtonActions; @class SBFolderTitleTextField; @class SBUIController; @class SBFolderBackgroundView; @class CSPageControl; @class SBMediaController; @class SBFLockScreenDateView; @class NCNotificationListSectionRevealHintView; @class UIKeyboardImpl; @class SBClickGestureRecognizer; @class MRUNowPlayingTransportControlsView; @class SBWallpaperViewController; 
