...
@class NCNotificationShortLookView; @class SBWallpaperViewController; @class SBNotificationBannerDestination; @class UIWindow; @class CSQuickActionsView; @class MTLumaDodgePillSettings; @class _UIStatusBarVisualProvider_iOS; @class SBHomeHardwareButton; @class SBLockScreenManager; @class SBPressGestureRecognizer; @class SBIconView; @class NCNotificationListCell; @class MRUNowPlayingTransportControlsView; @class SBIconProgressView; @class SBLockHardwareButton; @class BBBulletin; @class CSCoverSheetViewController; @class _UIStatusBarVisualProvider_Split54; @class MRUNowPlayingHeaderView; @class SBFLockScreenDateView; @class BSPlatform; @class _UIStatusBarSignalView; @class _UIStatusBarWifiSignalView; @class BBServer; @class SBHDefaultIconListLayoutProvider; @class _UIStatusBarData; @class NCNotificationListSectionRevealHintView; @class _UIStatusBarCellularSignalView; @class SBLockHardwareButtonActions; @class UIKeyboardImpl; @class SBMediaController; @class SBFloatingDockPlatterView; @class SBIconListPageControl; @class CSAdjunctItemView; @class SpringBoard; @class MRUNowPlayingLabelView; @class SBHomeHardwareButtonActions; @class MRUNowPlayingControlsView; @class _UIBatteryView; @class SBVolumeHardwareButton; @class SBClickGestureRecognizer; @class _UIStatusBarStringView; @class SBDockView; @class SBUIController; 
...
static __attribute__((constructor)) void _logosLocalCtor_e25f34e7(int __unused argc, char __unused **argv, char __unused **envp) {
	HBPreferences *file = [[HBPreferences alloc] initWithIdentifier:@"aquariusprefs"];
