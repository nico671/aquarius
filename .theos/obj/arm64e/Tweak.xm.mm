...
@class NCNotificationListSectionRevealHintView; @class _UIStatusBarSignalView; @class SBVolumeHardwareButton; @class SBWallpaperViewController; @class _UIStatusBarData; @class BBServer; @class SpringBoard; @class SBFLockScreenDateView; @class MTLumaDodgePillSettings; @class _UIStatusBarWifiSignalView; @class MRUNowPlayingLabelView; @class SBIconView; @class SBIconListPageControl; @class SBIconProgressView; @class SBLockScreenManager; @class SBHomeHardwareButtonActions; @class BBBulletin; @class SBUIController; @class CSAdjunctItemView; @class MRUNowPlayingTransportControlsView; @class SBPressGestureRecognizer; @class BSPlatform; @class SBNotificationBannerDestination; @class _UIBatteryView; @class _UIStatusBarStringView; @class SBLockHardwareButton; @class NCNotificationShortLookView; @class _UIStatusBarCellularSignalView; @class NCNotificationListCell; @class CSCoverSheetViewController; @class MRUNowPlayingHeaderView; @class SBClickGestureRecognizer; @class SBLockHardwareButtonActions; @class SBFloatingDockPlatterView; @class SBDockView; @class MRUNowPlayingControlsView; @class UIWindow; @class _UIStatusBarVisualProvider_Split54; @class SBHomeHardwareButton; @class SBHDefaultIconListLayoutProvider; @class SBMediaController; @class CSQuickActionsView; @class UIKeyboardImpl; @class _UIStatusBarVisualProvider_iOS; 
...
static NCNotificationShortLookView* _logos_method$notifications$NCNotificationShortLookView$init(_LOGOS_SELF_TYPE_INIT NCNotificationShortLookView* __unused self, SEL __unused _cmd) _LOGOS_RETURN_RETAINED {
	_logos_orig$notifications$NCNotificationShortLookView$init(self, _cmd);
	[self didMoveToWindow];
	return _logos_orig$notifications$NCNotificationShortLookView$init(self, _cmd);
}
...
static __attribute__((constructor)) void _logosLocalCtor_01523acb(int __unused argc, char __unused **argv, char __unused **envp) {
	HBPreferences *file = [[HBPreferences alloc] initWithIdentifier:@"aquariusprefs"];
