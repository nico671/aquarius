...
@class SBMediaController; @class _UIStatusBarWifiSignalView; @class CSAdjunctItemView; @class _UIStatusBarVisualProvider_Split54; @class SBPressGestureRecognizer; @class SBFLockScreenDateView; @class MRUNowPlayingHeaderView; @class BBBulletin; @class _UIStatusBarCellularSignalView; @class _UIStatusBarSignalView; @class _UIStatusBarVisualProvider_iOS; @class SBHomeHardwareButton; @class SBDockView; @class MRUNowPlayingLabelView; @class BBServer; @class SBClickGestureRecognizer; @class SBLockHardwareButtonActions; @class MRUNowPlayingControlsView; @class BSPlatform; @class SpringBoard; @class SBHomeHardwareButtonActions; @class _UIStatusBarStringView; @class SBHDefaultIconListLayoutProvider; @class CSQuickActionsView; @class _UIBatteryView; @class UIKeyboardImpl; @class UIWindow; @class SBIconListPageControl; @class MRUNowPlayingTransportControlsView; @class SBLockHardwareButton; @class NCNotificationListSectionRevealHintView; @class NCNotificationListCell; @class SBIconView; @class SBFStaticWallpaperView; @class SBUIController; @class SBVolumeHardwareButton; @class NCNotificationShortLookView; @class SBLockScreenManager; @class _UIStatusBarData; @class MTLumaDodgePillSettings; @class SBFloatingDockPlatterView; @class SBIconProgressView; @class UITabBar; @class CSCoverSheetViewController; 
...
static void _logos_method$musicplayer$MRUNowPlayingHeaderView$setNeedsLayout(_LOGOS_SELF_TYPE_NORMAL MRUNowPlayingHeaderView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd){
	_logos_orig$musicplayer$MRUNowPlayingHeaderView$setNeedsLayout(self, _cmd);
	[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(moveRoutingButton:) name:@"musicplayerframe" object:nil];
}

static void _logos_method$musicplayer$MRUNowPlayingHeaderView$moveRoutingButton$(_LOGOS_SELF_TYPE_NORMAL MRUNowPlayingHeaderView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, NSNotification * notification) {
...
static void _logos_method$gesturesAndModernShit$UITabBar$setNeedsLayout(_LOGOS_SELF_TYPE_NORMAL UITabBar* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd){
	_logos_orig$gesturesAndModernShit$UITabBar$setNeedsLayout(self, _cmd);
...
static __attribute__((constructor)) void _logosLocalCtor_96fdb82b(int __unused argc, char __unused **argv, char __unused **envp) {
