...
@class SBDockView; @class SpringBoard; @class SBVolumeHardwareButton; @class _UIStatusBarSignalView; @class _UIStatusBarData; @class UIWindow; @class SBMediaController; @class NCNotificationListSectionRevealHintView; @class _UIStatusBarStringView; @class SBPressGestureRecognizer; @class SBClickGestureRecognizer; @class SBIconProgressView; @class UITabBar; @class SBLockHardwareButtonActions; @class UIKeyboardImpl; @class CSAdjunctItemView; @class SBIconListPageControl; @class _UIBatteryView; @class MRUNowPlayingHeaderView; @class CSCoverSheetViewController; @class SBLockHardwareButton; @class BSPlatform; @class _UIStatusBarVisualProvider_iOS; @class NCNotificationShortLookView; @class SBHomeHardwareButton; @class _UIStatusBarWifiSignalView; @class SBHDefaultIconListLayoutProvider; @class SBFloatingDockPlatterView; @class NCNotificationListCell; @class SBFStaticWallpaperView; @class MRUNowPlayingTransportControlsView; @class _UIStatusBarVisualProvider_Split54; @class SBIconView; @class SBFLockScreenDateView; @class SBHomeHardwareButtonActions; @class CSQuickActionsView; @class MTLumaDodgePillSettings; @class SBBacklightController; @class _UIStatusBarCellularSignalView; @class MRUNowPlayingLabelView; @class MRUNowPlayingControlsView; @class SBUIController; 
