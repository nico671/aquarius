...
@class SBFLockScreenDateView; @class PLPlatterHeaderContentView; @class MRUNowPlayingLabelView; @class MRUNowPlayingTransportControlsView; @class SBLockHardwareButtonActions; @class SBIconView; @class CSCoverSheetViewController; @class _UIStatusBarCellularSignalView; @class SBMediaController; @class NCNotificationListSectionRevealHintView; @class SBBacklightController; @class BSPlatform; @class SBLockHardwareButton; @class _UIStatusBarVisualProvider_iOS; @class SBUIController; @class SBClickGestureRecognizer; @class SBHomeHardwareButton; @class SBVolumeHardwareButton; @class SBIconProgressView; @class SBHomeHardwareButtonActions; @class NCNotificationContentView; @class SBDockView; @class SBHDefaultIconListLayoutProvider; @class _UIStatusBarStringView; @class _UIBatteryView; @class NCNotificationShortLookView; @class SBFloatingDockPlatterView; @class MRUNowPlayingHeaderView; @class SBPressGestureRecognizer; @class _UIStatusBarData; @class _UIStatusBarSignalView; @class SBMainSwitcherViewController; @class MTLumaDodgePillSettings; @class MRUNowPlayingControlsView; @class NCNotificationListCell; @class CSQuickActionsView; @class _UIStatusBarWifiSignalView; @class SBIconListPageControl; @class SBFStaticWallpaperView; @class CSAdjunctItemView; @class _UIStatusBarVisualProvider_Split54; @class SpringBoard; 
...
static __attribute__((constructor)) void _logosLocalCtor_c6f27374(int __unused argc, char __unused **argv, char __unused **envp) {
