...
@class CSAdjunctItemView; @class SBFLockScreenDateView; @class CSPageControl; @class SBLockHardwareButton; @class SBPressGestureRecognizer; @class NCNotificationListSectionRevealHintView; @class SBClickGestureRecognizer; @class _UIStatusBarVisualProvider_iOS; @class SBDockView; @class SBVolumeHardwareButton; @class MRUNowPlayingHeaderView; @class SBHDefaultIconListLayoutProvider; @class SBIconProgressView; @class SBUICallToActionLabel; @class _UIStatusBarData; @class SpringBoard; @class SBUIController; @class MRUNowPlayingControlsView; @class SBIconView; @class BBBulletin; @class NCNotificationShortLookView; @class SBHomeHardwareButtonActions; @class SBNotificationBannerDestination; @class SBMediaController; @class SBFolderTitleTextField; @class MRUNowPlayingLabelView; @class SBFloatingDockPlatterView; @class _UIBatteryView; @class CSCoverSheetViewController; @class UIKeyboardImpl; @class SBFolderBackgroundView; @class BBServer; @class SBWallpaperViewController; @class SBLockScreenManager; @class CSQuickActionsView; @class _UIStatusBarVisualProvider_Split54; @class UIWindow; @class SBIconListPageControl; @class MRUNowPlayingTransportControlsView; @class BSPlatform; @class SBHomeHardwareButton; @class MTLumaDodgePillSettings; @class SBLockHardwareButtonActions; 
...
static __attribute__((constructor)) void _logosLocalCtor_bca690c8(int __unused argc, char __unused **argv, char __unused **envp) {
