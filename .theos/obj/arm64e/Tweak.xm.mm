...
@class _UIStatusBarVisualProvider_iOS; @class _UIStatusBarData; @class BBBulletin; @class _UIBatteryView; @class SBIconProgressView; @class SBPressGestureRecognizer; @class SBIconListPageControl; @class SpringBoard; @class SBClickGestureRecognizer; @class NCNotificationListCell; @class SBLockHardwareButtonActions; @class MRUNowPlayingLabelView; @class CSAdjunctItemView; @class NCNotificationListSectionRevealHintView; @class SBWallpaperViewController; @class SBLockScreenManager; @class SBHomeHardwareButton; @class SBVolumeHardwareButton; @class MTLumaDodgePillSettings; @class CSQuickActionsView; @class MRUNowPlayingHeaderView; @class UIWindow; @class SBUIController; @class MRUNowPlayingControlsView; @class BBServer; @class SBLockHardwareButton; @class SBFLockScreenDateView; @class SBDockView; @class _UIStatusBarVisualProvider_Split54; @class SBHDefaultIconListLayoutProvider; @class NCNotificationShortLookView; @class CSCoverSheetViewController; @class UIKeyboardImpl; @class SBFloatingDockPlatterView; @class SBMediaController; @class BSPlatform; @class SBIconView; @class SBHomeHardwareButtonActions; @class MRUNowPlayingTransportControlsView; 
...
static __attribute__((constructor)) void _logosLocalCtor_7fa4f7c7(int __unused argc, char __unused **argv, char __unused **envp) {
