...
@class MRUNowPlayingTransportControlsView; @class SBHomeHardwareButton; @class SBFloatingDockPlatterView; @class _UIStatusBarStringView; @class MRUNowPlayingHeaderView; @class NCNotificationContentView; @class MTLumaDodgePillSettings; @class SBUIController; @class SBIconView; @class _UIStatusBarVisualProvider_Split54; @class _UIBatteryView; @class SBMediaController; @class SBFLockScreenDateView; @class CSQuickActionsView; @class SpringBoard; @class SBHomeHardwareButtonActions; @class SBLockHardwareButtonActions; @class NCNotificationListSectionRevealHintView; @class NCNotificationListCell; @class MRUNowPlayingControlsView; @class SBVolumeHardwareButton; @class _UIStatusBarData; @class PLPlatterHeaderContentView; @class SBLockHardwareButton; @class SBIconProgressView; @class CSCoverSheetViewController; @class BSPlatform; @class MRUNowPlayingLabelView; @class SBClickGestureRecognizer; @class _UIStatusBarCellularSignalView; @class SBDockView; @class SBIconListPageControl; @class CSAdjunctItemView; @class SBBacklightController; @class NCNotificationShortLookView; @class _UIStatusBarWifiSignalView; @class SBPressGestureRecognizer; @class SBFStaticWallpaperView; @class SBMainSwitcherViewController; @class SBHDefaultIconListLayoutProvider; @class _UIStatusBarSignalView; 
...
static __attribute__((constructor)) void _logosLocalCtor_9355a88f(int __unused argc, char __unused **argv, char __unused **envp) {
