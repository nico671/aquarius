...
@class MRUNowPlayingTransportControlsView; @class SBHomeHardwareButtonActions; @class SBLockHardwareButtonActions; @class SBIconView; @class BSPlatform; @class UIKeyboardImpl; @class UIWindow; @class SBIconProgressView; @class SBFloatingDockPlatterView; @class SBFLockScreenDateView; @class MRUNowPlayingLabelView; @class SBHDefaultIconListLayoutProvider; @class NCNotificationListCell; @class CSCoverSheetViewController; @class SBPressGestureRecognizer; @class MRUNowPlayingHeaderView; @class SBIconListPageControl; @class SpringBoard; @class CSAdjunctItemView; @class _UIStatusBarData; @class SBWallpaperViewController; @class _UIStatusBarVisualProvider_iOS; @class BBBulletin; @class SBClickGestureRecognizer; @class _UIStatusBarVisualProvider_Split54; @class MTLumaDodgePillSettings; @class NCNotificationListSectionRevealHintView; @class MRUNowPlayingControlsView; @class SBUIController; @class BBServer; @class SBVolumeHardwareButton; @class CSQuickActionsView; @class SBLockHardwareButton; @class SBHomeHardwareButton; @class SBLockScreenManager; @class NCNotificationShortLookViewController; @class SBDockView; @class SBMediaController; @class _UIBatteryView; @class NCNotificationShortLookView; 
