...
@class NCNotificationListSectionRevealHintView; @class SBVolumeHardwareButton; @class CSQuickActionsView; @class SpringBoard; @class _UIStatusBarData; @class _UIStatusBarSignalView; @class SBClickGestureRecognizer; @class MRUNowPlayingLabelView; @class SBIconView; @class SBHomeHardwareButton; @class SBIconProgressView; @class SBLockScreenManager; @class _UIStatusBarStringView; @class _UIBatteryView; @class SBHDefaultIconListLayoutProvider; @class BSPlatform; @class SBUIController; @class NCNotificationShortLookView; @class MRUNowPlayingControlsView; @class UIWindow; @class _UIStatusBarVisualProvider_Split54; @class _UIStatusBarVisualProvider_iOS; @class SBNotificationBannerDestination; @class SBFLockScreenDateView; @class BBBulletin; @class MTLumaDodgePillSettings; @class SBLockHardwareButtonActions; @class SBFloatingDockPlatterView; @class CSAdjunctItemView; @class SBPressGestureRecognizer; @class CSCoverSheetViewController; @class SBLockHardwareButton; @class _UIStatusBarCellularSignalView; @class UIKeyboardImpl; @class SBDockView; @class SBHomeHardwareButtonActions; @class NCNotificationListCell; @class SBIconListPageControl; @class MRUNowPlayingHeaderView; @class SBWallpaperViewController; @class BBServer; @class MRUNowPlayingTransportControlsView; @class SBMediaController; @class _UIStatusBarWifiSignalView; 
